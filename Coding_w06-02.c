...
// W06-02-02 (ตัวแปร double)
double x = 1.0;
double y = 2.0;
double z; // ยังไม่กำหนดค่า

printf("W06-02-02:\n");
printf("1. x = %.1f, y = %.1f, z = %.1f\n", x, y);

x = y + 5.0; // x = 2.0 + 5.0 = 7.0
printf("2. x = %.1f, y = %.1f, z = %.1f\n", x, y);
y = x / 2.0; // y = 7.0 / 2.0 = 3.5
printf("3. x = %.1f, y = %.1f, z = %.1f\n", x, y);
y = (x * 3.0) + 4.0; // y = 21.0 + 4.0 = 25.0
printf("4. x = %.1f, y = %.1f, z = %.1f\n", x, y);
x = -0.5 - y; // x = -0.5 - 25.0 = -25.5
printf("5. x = %.1f, y = %.1f, z = %.1f\n", x, y);
